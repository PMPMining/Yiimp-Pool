...
<!-- Change your demo wallet here -->
	...
	<tr>
			<td colspan="5"><p class="main-left-box" style="padding: 3px; background-color: #ffffee; font-family: monospace;" id="output">-a  -o stratum+tcp://<?=YAAMP_SITE_URL?>:0000 -u . -p c=</p>
		</td>
	</tr>
</tbody>
</table>
...
<ul class="social-icons">
    ...
    <li><a href="https://www.youtube.com/channel/UCXdH6xeRM1v4uebHFVJaKww"><img src='/images/YouTube.png' /></a></li>
    <li><a href="https://github.com/MonkeyD-Core"><img src='/images/Github.png' /></a></li>
